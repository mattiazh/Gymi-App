...
function displayQuestion() {
    ...
    if (isCorrectionPhase) {
        categoryTitle = "Korrektur: " + categoryTitle; // Adjust this to reflect how you want to display the title during correction
    }
...
function startTimer(duration, display) {
    ...
    timerInterval = setInterval(function () {
        ...
        if (--timer < 0) {
            ...
            // When the timer runs out, you can call a function or update the display as needed
        }
    }, 1000);
}
